 ...
 *
 * A new `itemId` restarts the bar from full. `onTimeout` is read through a ref
 * so the latest handler (with fresh game state) always fires.
 */
